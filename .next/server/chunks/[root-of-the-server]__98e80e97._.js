...
async function POST(req) {
    try {
        ...
        let resolvedTicketUrl = ticketUrl;
        if (!resolvedTicketUrl && bookingId) {
            try {
                const resource = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].api.resource(`tickets/${bookingId}`, {
                    resource_type: "raw"
                });
                ...
                try {
                    ...
                    if (booking) {
                        ...
                        resolvedTicketUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$uploadTicket$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uploadTicket"])(pdfBuffer, booking.bookingReference);
                    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__98e80e97._.js.map