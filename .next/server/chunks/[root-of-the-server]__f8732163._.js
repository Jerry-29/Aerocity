...
"[project]/lib/hero-store.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const heroFile = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dataDir, "hero.json");
...
async function readHero() {
    try {
        await ensureDir();
        const raw = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].readFile(heroFile, "utf8");
...
async function writeHero(hero) {
    await ensureDir();
    await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(heroFile, JSON.stringify(hero), "utf8");
}
async function clearHero() {
    try {
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].unlink(heroFile);
    } catch  {
    // ignore
    }
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hero$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/hero-store.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(request) {
    try {
        ...
        const hero = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hero$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readHero"])();
...
async function POST(request) {
    try {
        ...
        const { id, type, url, thumbnailUrl } = body || {};
        if (!id || !type || !url) {
            // attempt to read from DB if only id passed
            if (id) {
                ...
                if (media) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hero$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeHero"])({
                        id: media.id,
                        type: media.type,
                        url: media.url,
                        thumbnailUrl: media.thumbnailUrl || null,
                        createdAt: media.createdAt?.toISOString?.() || undefined
                    });
...
async function DELETE(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hero$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clearHero"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f8732163._.js.map