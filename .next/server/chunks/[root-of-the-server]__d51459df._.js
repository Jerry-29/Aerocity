...
async function POST(request) {
    try {
        ...
        if (hasModel) {
            ...
            // Graceful fallback: acknowledge receipt even if storage fails
            }
        } else {
            console.warn("[contact] ContactMessage model not available; acknowledging without DB");
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d51459df._.js.map