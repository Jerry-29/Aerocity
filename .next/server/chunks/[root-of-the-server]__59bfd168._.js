module.exports = [
"[project]/.next-internal/server/app/api/hero/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function GET(_request) {
    try {
        let hero = null;
        try {
            const active = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].media.findFirst({
                where: {
                    category: "HERO",
                    isPublic: true
                },
            ...
            hero = active || await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].media.findFirst({
                where: {
                    category: "HERO"
                },
                orderBy: {
        ...
        if (!hero) {
            try {
                hero = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].media.findFirst({
                    where: {
                        category: "GENERAL",
                        isPublic: true
                    },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__59bfd168._.js.map